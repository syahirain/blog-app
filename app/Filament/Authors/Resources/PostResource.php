...
namespace App\Filament\Authors\Resources;
...
use App\Models\Post;
use App\Filament\Authors\Resources\PostResource\Pages;
            ...
            ->schema([
                Forms\Components\Section::make()
                    ->schema([
                        ...
                        Forms\Components\Hidden::make('blog_author_id')
                        ->default(Auth::id()),
